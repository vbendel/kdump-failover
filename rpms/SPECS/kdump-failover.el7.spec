...
install -m 644 $RPM_BUILD_DIR/kdump-failover-0.2/kdump-failover.service $RPM_BUILD_ROOT/usr/lib/systemd/system/kdump-failover.service
...
/usr/lib/systemd/system/kdump-failover.service

%preun
systemctl disable kdump-failover
