...
install -m 644 $RPM_BUILD_DIR/kdump-failover/rhel5/kdump-failover-el5.conf $RPM_BUILD_ROOT/etc/kdump-failover.conf
install -d -m 755 $RPM_BUILD_ROOT/var/crash/scripts
install -m 755 $RPM_BUILD_DIR/kdump-failover/rhel5/kdump-post-local-failover-el5.sh $RPM_BUILD_ROOT/var/crash/scripts/kdump-post-local-failover.sh
install -d -m 755 $RPM_BUILD_ROOT/usr/bin
install -m 755 $RPM_BUILD_DIR/kdump-failover/rhel5/kdump-failover-config-generator-el5.sh $RPM_BUILD_ROOT/usr/bin/kdump-failover-config-generator.sh
